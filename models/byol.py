...
class BYOL(nn.Module):
    ...
    """
    def __init__(self, encoder_q, encoder_k, dim=512, pred_dim=512, m=0.996):
        """
    ...
    def forward(self, x1, x2, bn_name=None):
        """
        Input:
        ...
        p1 = self.predictor(self.encoder_q(x1, bn_name))  # NxC
        z2 = self.encoder_k(x2, bn_name)  # NxC

        p2 = self.predictor(self.encoder_q(x2, bn_name))  # NxC
        z1 = self.encoder_k(x1, bn_name)  # NxC
