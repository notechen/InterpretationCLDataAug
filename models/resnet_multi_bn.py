...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x, bn_name=None, return_feat=False):
    ...
    def forward(self, x, bn_name=None, return_feat=False):
        return self._forward_impl(x, bn_name, return_feat)
