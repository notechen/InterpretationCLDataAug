...
parser.add_argument('--experiment', type=str, default='ACL_DS_SEMI_STAGE2_0.01LABELS', help='exp name')
...
parser.add_argument('--checkpoint', default='checkpoints/ACL_DS/model_1000.pt', type=str,
...
parser.add_argument('--trainset', type=str, default='train0.01_idx',
